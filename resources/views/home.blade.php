            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">"Absolutely stunning hotel with impeccable service. The rooms are spacious and luxurious, and the staff went above and beyond to make our stay special. Will definitely return!"</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">"The hotel exceeded all my expectations. The room was immaculate, the dining options were excellent, and the location is perfect for both business and leisure. Highly recommend!"</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">"We celebrated our anniversary here and it was magical. The spa treatments were rejuvenating, and the special dinner arranged by the staff was unforgettable. Thank you for making our occasion so special!"</p>
                    </div>
                </div>
            </div>
        </div>
